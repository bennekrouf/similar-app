...
import {UserPreferenceModalProps} from './SourateConfiguration/UserPreferenceModalProps';

const GenericModal: React.FC<UserPreferenceModalProps> = ({ visible, onClose, onLogout, children, showFooter }) => {
  return (
    <Modal
      visible={visible}
      animationType="slide"
